...
var sendClinicAppointment = function sendClinicAppointment(phone, languageCode, messageBody) {
  var requestBody, sendMessage;
  return regeneratorRuntime.async(function sendClinicAppointment$(_context) {
    while (1) {
...
module.exports = {
  sendClinicAppointment: sendClinicAppointment
};